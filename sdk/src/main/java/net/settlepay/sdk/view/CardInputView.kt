package net.settlepay.sdk.view
...
import net.settlepay.sdk.R
import net.settlepay.sdk.data.model.CardInputData
import net.settlepay.sdk.util.MaskWatcher
import net.settlepay.sdk.util.openScan
import net.settlepay.sdk.util.showToast
